...
from imperiumab.kokes_od_db_eufondy import KokesOdDbEufondy
from imperiumab import company_csv, subsidy_csv

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Find subsidies of Czech companies from eufondy database, writes the result to data/subsidies_from_eufondy.csv.')
    ...
    parser.add_argument('--kokes-od-connstring', required=True,
                        help='Connection string to the PostgreSQL database with eufondy data downloaded via kokes/od. Ex: postgresql://localhost/od')
