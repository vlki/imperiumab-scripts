...
from lib import company_csv, company_wiki

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Export list of companies from Imperium AB wiki to CSV file data/companies_export.csv')
