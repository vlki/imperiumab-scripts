...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Find subsidies of Czech companies from CEDR database, writes the result to data/subsidies_from_cedr.csv.')
    ...
    parser.add_argument('--kokes-od-connstring', required=True, help='Connection string to the PostgreSQL database with cedr data downloaded via kokes/od. Ex: postgresql://localhost/od')
    ...
    for company in companies:
        ...
        company_subsidies = kokes_od_db_cedr.search_subsidies_of_company(company)
    ...
    csv_path = 'data/subsidies_from_cedr.csv'
